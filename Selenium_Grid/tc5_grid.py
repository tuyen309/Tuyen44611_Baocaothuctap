...
class Testcase5(unittest.TestCase):
    ...
    def test_case5(self):
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,'.//select[@id="listings-sort"]/option[contains(string(), "Duration (Longest)")]').click()
        time.sleep(5)
        timelist =[]
        for j in range(1,9):
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        Testcase5.BROWSER = sys.argv.pop()
        Testcase5.PLATFORM = sys.argv.pop()
